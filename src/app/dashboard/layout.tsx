  ...
  return (
    <div className="flex h-screen bg-[#020617] overflow-hidden">
      ...
      <motion.aside
        ...
        className={cn(
          "fixed lg:relative flex flex-col h-full bg-[#030712] border-r border-white/5 z-50 transition-all duration-300",
      ...
      <main className="flex-1 h-full overflow-y-auto px-6 lg:px-12 py-8 custom-scrollbar relative">
         ...
         <div className="flex items-center justify-between mb-10 pb-8 border-b border-white/5">
            ...
            <div className="flex items-center gap-4">
               <Link href="/docs" className="hidden sm:flex items-center gap-2 text-[10px] font-bold text-slate-500 uppercase tracking-widest hover:text-sage transition-all">
